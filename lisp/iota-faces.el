...
(defface iota-box-face
  '((t :inherit vertical-border :background unspecified))
...
(defface iota-active-box-face
  '((t :inherit mode-line :underline nil :overline nil :strike-through nil :background unspecified))
  "Face for box borders in active window.
Inherits from mode-line for theme-appropriate color.
Explicitly disables underline/overline/background to prevent artifacts."
  :group 'iota-faces)

(defface iota-inactive-box-face
  '((t :inherit shadow :underline nil :overline nil :strike-through nil :background unspecified))
