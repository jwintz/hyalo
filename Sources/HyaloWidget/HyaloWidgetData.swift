...
public enum HyaloWidgetStore {
    ...
    public static func read() -> HyaloWidgetData {
        // Sandboxed widget with App Group entitlement can read from Group Containers
        guard let groupURL = FileManager.default.containerURL(
                forSecurityApplicationGroupIdentifier: HyaloAppGroup.suiteName
              ) else {
            return .placeholder
        }
        let url = groupURL.appendingPathComponent("widget-data.json")
